...
function getweights(runner::Runner, model::ABM)
    ...
    for i in 1:dim[1],
        ...
        laneweights[i] += (runner.exhaustion
...
[[deps.Agents]]
deps = ["CSV", "DataFrames", "DataStructures", "Distributed", "Distributions", "Downloads", "Graphs", "JLD2", "LazyArtifacts", "LightOSM", "LinearAlgebra", "Pkg", "ProgressMeter", "Random", "Requires", "Rotations", "Scratch", "StaticArrays", "StatsBase"]
git-tree-sha1 = "d8beeb321d7a1bf8afda307be0eacbcd0b7567dc"
...
git-tree-sha1 = "b625fa2395df032a501971987a34a630aeac493a"
